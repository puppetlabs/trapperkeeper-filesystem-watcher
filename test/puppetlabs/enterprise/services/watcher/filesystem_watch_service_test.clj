(ns puppetlabs.enterprise.services.watcher.filesystem-watch-service-test
  (:require [clojure.test :refer [deftest testing is use-fixtures]]
            [clojure.set :as set]
            [schema.test :as schema-test]
            [me.raynes.fs :as fs]
            [puppetlabs.enterprise.services.protocols.filesystem-watch-service :refer :all]
            [puppetlabs.enterprise.services.watcher.filesystem-watch-service :refer [filesystem-watch-service]]
